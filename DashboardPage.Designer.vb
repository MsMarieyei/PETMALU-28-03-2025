...
Partial Class DashboardPage
    ...
    Private Sub InitializeComponent()
        ...
        BtnHistory.Location = New Point(72, 892)
        ...
        LinkLogout.Font = New Font("Showcard Gothic", 28.2F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        LinkLogout.LinkColor = Color.FromArgb(CByte(0), CByte(64), CByte(64))
        LinkLogout.Location = New Point(1636, 910)
        LinkLogout.Name = "LinkLogout"
        LinkLogout.Size = New Size(210, 59)
        ...
        LinkPetInfo.Font = New Font("Showcard Gothic", 46.2F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        LinkPetInfo.LinkColor = Color.FromArgb(CByte(0), CByte(64), CByte(0))
        LinkPetInfo.Location = New Point(475, -8)
        LinkPetInfo.Name = "LinkPetInfo"
        LinkPetInfo.Size = New Size(580, 192)
        ...
        LinkTest.Location = New Point(570, 962)
        LinkTest.Name = "LinkTest"
        LinkTest.Size = New Size(35, 20)
        LinkTest.TabIndex = 8
        ...
        Label2.Location = New Point(685, 308)
        Label2.Name = "Label2"
        ...
        Label3.Location = New Point(1276, 249)
        Label3.Name = "Label3"
        ...
        Label5.Location = New Point(685, 367)
        Label5.Name = "Label5"
        ...
        Label6.Location = New Point(744, 417)
        Label6.Name = "Label6"
        ...
        Label7.Location = New Point(1323, 308)
        Label7.Name = "Label7"
    ...
    Friend WithEvents LinkTest As LinkLabel
