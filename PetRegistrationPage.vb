    ...
    Private Sub InsertDewormings(petID As String, connection As MySqlConnection)
        If RbtnYesDeworm.Checked Then
            For Each item As String In CheckedDeworming.CheckedItems
                Dim dewormingQuery As String = "INSERT INTO PetDewormings (PetID, DewormingID, DewormingDate) VALUES (@PetID, (SELECT DewormingID FROM Dewormings WHERE DewormingName = @Deworming), CURDATE())"
