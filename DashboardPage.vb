Public Class DashboardPage
    ...
    Private Sub Linktest_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkTest.LinkClicked
        Dim TestConnection As New TestConnection()
        TestConnection.Show()
        Me.Hide()
    End Sub
